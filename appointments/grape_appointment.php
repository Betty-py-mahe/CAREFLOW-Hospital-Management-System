...
">
    ...
    ">
        ...
        <a
        href="../reports/melon_appointment_report.php"
        style="
            display:inline-flex;
            align-items:center;
            gap:7px;
        ...
        <div style="position:relative;">
            ...
            <button
            type="button"
            onclick="toggleAppointmentDownload()"
            style="
                display:inline-flex;
                align-items:center;
                gap:7px;
            ...
            >
                ...
                <a
                href="../reports/melon_appointment_report.php?download=csv"
                style="
                    display:block;
                    padding:10px 14px;
                    color:darkslategray;
                ...
                <a
                href="../downloads/appointment_pdf.php"
                style="
                    display:block;
                    padding:10px 14px;
                    color:darkslategray;
                ...
                <a
                href="../downloads/appointment_docx.php"
                style="
                    display:block;
                    padding:10px 14px;
                    color:darkslategray;
...
function toggleAppointmentDownload()
{
    var menu =
        document.getElementById(
            "appointmentDownloadMenu"
        );
